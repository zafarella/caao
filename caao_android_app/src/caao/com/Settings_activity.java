...
public class Settings_activity extends ListActivity {
	...
	case ABOUT_DIALOG:
	    // the about dialog
	    // ------------------------------------------------------------------------------
	    dialog = new AlertDialog.Builder(Settings_activity.this).setTitle(
		    getString(R.string.about_dialog_title)).setMessage(
		    getString(R.string.about_dialog_content_text)).create();
	    // ------------------------------------------------------------------------------
	    break;
	case LICENSE_DIALOG:
	    // the license dialog
	    // ------------------------------------------------------------------------------
	    dialog = new AlertDialog.Builder(Settings_activity.this).setTitle(
		    getString(R.string.licence_dialog_title)).setMessage(
		    getString(R.string.license_dialog_licence_text)).create();
	    // ------------------------------------------------------------------------------
	    break;
