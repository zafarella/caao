...
public class CalendarActivity extends Activity implements
     ...
     * ""vnd.android.cursor.dir/vnd.caao.com.tabs.calendar.date"")
     */
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.mView = (CalendarView) findViewById(R.id.calendarView);
    ...
    public void onTouch(Cell cell) {
        ...
        if (this.mView.firstDay(day))
            this.mView.previousMonth();
        else if (this.mView.lastDay(day))
            ...
            public void run() {
                Toast.makeText(
                        ...
                        DateUtils.getMonthString(
                                CalendarActivity.this.mView.getMonth(),
